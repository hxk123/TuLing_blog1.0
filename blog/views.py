...
class IndexView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # 讲分页导航条的模板变量更新到 context 中，注意 pagination_data 方法返回的也是一个字典
        context.update(pagination_data)

        # 更新后context 返回， 以便 ListView 使用这个字典中的模板变量去渲染模板
        return context
    ...
    def pagination_data(self, paginator, page, is_paginated):
        ...
        if page_number == 1:
            ...
            left = page_range[(page_number-3) if (page_number-3) > 3 else 0:page_number - 1]
            if left[0]>2:
                left_has_more = True
...
class PostDetailView(DetailView):
    ...
    def get(self, request, *args, **kwargs):
        # 复写 get 方法目的是因为每当文章被访问一次，就得将文章阅读量 +1
    ...
    def get_object(self, queryset=None):
        # 复写 get_object 方法是因为需要对 post 的body 进行渲染
    ...
    def get_context_data(self, **kwargs):
        # 除了将 post 传递给模板外(DatailView已经完成)
